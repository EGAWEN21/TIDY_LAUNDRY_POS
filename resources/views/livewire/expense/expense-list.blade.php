                        ...
                        <tr>
                            ...
                            <td class="text-center"> 
                                <div class="d-flex align-items-center gap-10 justify-content-center">
                                    ...
                                    @endcan
                                    @can('expense_delete')
                                        <button type="button" class="remove-item-button bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium tw-size-8 d-flex justify-content-center align-items-center rounded-circle" onclick="confirmDelete(() => @this.delete({{ $row->id }}))"> 
