...
- Name: POS route smoke coverage >> failed offline sync retains the queue and recovers on retry
- Location: C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:143:5
...
Call log:
  - navigating to "http://tidypos.test/", waiting until "load"
    ...
    at C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:145:15
```
