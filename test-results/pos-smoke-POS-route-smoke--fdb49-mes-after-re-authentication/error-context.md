...
- Name: POS route smoke coverage >> expired POS token preserves queue and resumes after re-authentication
- Location: C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:378:5
...
Call log:
  - navigating to "http://tidypos.test/", waiting until "load"
    ...
    at C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:380:15
```
