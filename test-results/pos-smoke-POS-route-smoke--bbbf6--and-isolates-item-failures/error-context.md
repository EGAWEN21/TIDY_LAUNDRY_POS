...
- Name: POS route smoke coverage >> synchronizes six queued orders in batches of five and isolates item failures
- Location: C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:288:5
...
Call log:
  - navigating to "http://tidypos.test/", waiting until "load"
    ...
    at C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:290:15
```
