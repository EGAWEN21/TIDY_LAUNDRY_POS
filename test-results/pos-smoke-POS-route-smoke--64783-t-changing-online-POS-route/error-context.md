...
- Name: POS route smoke coverage >> offline POS registers its service worker without changing online POS route
- Location: C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:471:5
...
Call log:
  - navigating to "http://tidypos.test/", waiting until "load"
    ...
    at C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:473:15
```
