...
- Name: POS route smoke coverage >> authenticated user can open the online Livewire POS
- Location: C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:21:5
...
Call log:
  - navigating to "http://tidypos.test/", waiting until "load"
    ...
    at C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:23:15
```
