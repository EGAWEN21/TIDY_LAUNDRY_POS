...
- Name: POS route smoke coverage >> authenticated user can open the offline Vue/PWA POS shell
- Location: C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:29:5
...
Call log:
  - navigating to "http://tidypos.test/", waiting until "load"
    ...
    at C:\Users\DELL\Herd\tidypos\tests\e2e\pos-smoke.spec.js:31:15
```
